...
@Component({
  selector: 'eb-requisition-manager',
  templateUrl: './requisition-manager.component.html',
  styleUrls: ['./requisition-manager.component.scss']
})
export class RequisitionManagerComponent implements OnInit {
